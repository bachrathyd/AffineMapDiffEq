...
anim = @animate for k2 in 10.0 .^ LinRange(1,6,200)
g = 0.17#0.25#gap
...
xlabel!("x")
ylabel!("dx/dt")
plot(aaa,bbb, title = "k2 $(Printf.@sprintf("%.1e", k2))")

end

mp4(anim, "impact_different_stiffness.mp4", fps = 20)
#mp4(anim, "impact_different_stiffness_with_acc.mp4", fps = 20)
