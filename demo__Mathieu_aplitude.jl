...
@time sol = solve(probMathieu; Solver_args...);#abstol,reltol
...
δv = -1.0:0.51:5.0 # initial grid in x direction
ϵv = -0.001:0.5:10.0 # initial grid in y direction
...
b=0.05;
ax1 = Axis(0.0:1.0:5.0, "δ") # initial grid in x direction
...
δv = 0:0.51:10 # initial grid in x direction
bv = -1.501:0.5:1.5 # initial grid in y direction
...
ax1 = Axis(0.0:2.0:10.0, "δ") # initial grid in x direction
